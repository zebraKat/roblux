...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	MainFrame.BackgroundColor3 = Color3.fromRGB(24, 24, 25)
	...
	LeftFrame.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
	...
	function Flux:Notification(desc,buttontitle)
		...
		CloseBtn.BackgroundColor3 = Color3.fromRGB(31, 33, 36)
	...
	function Tabs:Tab(text,ico)
		...
		function ContainerContent:Button(text, desc, callback)
			...
			CircleSmall.BackgroundColor3 = Color3.fromRGB(39,39,39)
